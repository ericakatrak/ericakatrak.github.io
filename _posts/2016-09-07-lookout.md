...
<ul class="grid fade grid-full" id="grid-full">
  ...
  <li><p class="meta">You probably know this, but the apps featured here aren't actually unsafe... they're just used as examples :)</p></li>
...
<section>
  ...
  <p>With the product strategically redesigned, we were able to continue to extend it and quickly build other tools to form a suite of security products that could work together like legos.</p>
