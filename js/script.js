...
jribbble.shots({token: "32346fbe05ad04f207853e86cc955846ead40d6aece66eec3b1342a19d57be0b", per_page: 54}, function(shotsArray) {
...
$(document).mousemove(function(event) {
  ...
  $('.radial-gradient').css('background', 'radial-gradient(at ' + mouseXpercentage + '% ' + mouseYpercentage + '%, #2C2625, #1D1918)');
});
